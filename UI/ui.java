        ...
        switch (e.getType()) {
            case TEXT:
                if (!Panic.isPanic) {
                    ...
                    try {
                        String text = Client.cName + "§f | " + "§f | Name: §a kirzik " + "§f | UID: §a 1337 "+ mc.getSession().getUsername() + " | " + Objects.requireNonNull(mc.getCurrentServerData()).serverIP +
                ...
                /*
                fr.drawString("Rich§aClient §a1.0", 5, 5, -1);
                 ...
                 */
                    ...
                    Minecraft.getMinecraft().fontRenderer.drawString("FPS: " + Minecraft.getDebugFPS(), 5, 5, 3);
                }
            default:
                break;
        }
